...
class WebServerTests(unittest.TestCase):
    ...
    def test_static_dashboard_has_accessible_external_assets(self) -> None:
        ...
        self.assertIn('data-i18n="kind-coverage"', html)
        self.assertIn('id="task-result"', html)
        self.assertIn('class="coverage-guide', html)
        ...
        self.assertIn("function renderHumanResult", script)
        self.assertIn('"workspace-title": "找到仍然可以通过的路径。"', script)
