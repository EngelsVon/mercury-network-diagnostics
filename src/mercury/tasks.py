...
_ALLOWED_EVIDENCE = {
    ...
    ProbeKind.TCP_CONNECT: frozenset({EvidenceKind.TCP_CONNECTED, EvidenceKind.TCP_REFUSED, EvidenceKind.TCP_RESET, EvidenceKind.NETWORK_UNREACHABLE, EvidenceKind.HOST_UNREACHABLE, EvidenceKind.ADMIN_PROHIBITED, EvidenceKind.TIMEOUT, EvidenceKind.SILENT, EvidenceKind.PEER_OBSERVED_ARRIVAL, EvidenceKind.PEER_ACKNOWLEDGEMENT, EvidenceKind.DNS_QUERY, EvidenceKind.SSH_BANNER, EvidenceKind.EXECUTION_ERROR}),
    ProbeKind.UDP_EXCHANGE: frozenset({EvidenceKind.UDP_APPLICATION_REPLY, EvidenceKind.PEER_OBSERVED_ARRIVAL, EvidenceKind.PEER_ACKNOWLEDGEMENT, EvidenceKind.DNS_QUERY, EvidenceKind.ICMP_UNREACHABLE, EvidenceKind.NETWORK_UNREACHABLE, EvidenceKind.HOST_UNREACHABLE, EvidenceKind.ADMIN_PROHIBITED, EvidenceKind.TIMEOUT, EvidenceKind.SILENT, EvidenceKind.EXECUTION_ERROR}),
